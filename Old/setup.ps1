#TODO:
# - Add/remove windows features w/ commands
	...
	# (want to remove fax printer and xps viewer
# - Create shortcuts to shell:startup for a needed programs
# - Remove recently added apps from start menu via regedits
# - implement internet speed fix regedits
# - Enable "underline access keys when avail" (regedit?)
# - Enable "use print screen to open screen snip" (regedit?)
# - disable sticky keys, shortcut keys, toggle keys and filter keys (regedit?)
# - set default apps
# - disable shared experiences
#???? - add mapped drives for games and user documents????
...
function SetPowerPlan()
{
    ...
    powercfg /Import $PWD\powerplan $planGUID
